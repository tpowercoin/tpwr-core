...
RESOURCES += src/qt/tpwr.qrc src/qt/tpwr_locale.qrc

TRANSLATIONS += src/qt/locale/tpwr_bg.ts \
                src/qt/locale/tpwr_de.ts \
                src/qt/locale/tpwr_en.ts \
                src/qt/locale/tpwr_es.ts \
                src/qt/locale/tpwr_fi.ts \
                src/qt/locale/tpwr_fr.ts \
                src/qt/locale/tpwr_it.ts \
                src/qt/locale/tpwr_ja.ts \
                src/qt/locale/tpwr_pl.ts \
                src/qt/locale/tpwr_pt.ts \
                src/qt/locale/tpwr_ru.ts \
                src/qt/locale/tpwr_sk.ts \
                src/qt/locale/tpwr_sv.ts \
                src/qt/locale/tpwr_vi.ts \
                src/qt/locale/tpwr_zh_CN.ts \
                src/qt/locale/tpwr_zh_TW.ts
