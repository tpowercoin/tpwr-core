...
In order to support loading of multiple wallets in tpwr-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tpwr.cpp.
...
Changes to tpwr.cpp
----------------------
tpwr.cpp is the entry point into tpwr-qt, and as such, will require some minor modifications to provide hooks for
