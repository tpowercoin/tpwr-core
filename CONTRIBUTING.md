Contributing to TPWR Core
============================

The TPWR Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TPWR Core project, and is not to be
confused with overall TPWR Network Protocol consensus changes.

Whether a pull request is merged into TPWR Core rests with the project merge
...
Patches that change TPWR consensus rules are considerably more involved than
...
Where a patch set proposes to change the TPWR consensus, it must have been
...
The project leader is the release manager for each TPWR Core release.
