...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (      0, uint256("0x00000224b41a6f29aa84bb68928295b63b9ace770a571fd0b6be53bf7dae1013"))
	(  10551, uint256("0xd9ff5ecb0630119968f36fc9604c6db4da29f06a384307d853245ef31d289007"))
	(  45789, uint256("0xe842aaf08c3298bae5aed753dcd7c94faede2c1885be5cd5f838d1f45294096e"))
	( 107898, uint256("0x2d7ab380181dcc416093f166c5b187784619161d8208d9b6aefec9c5e5b619af"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1605220778,   // UNIX timestamp of last checkpoint block
    217189,                  // total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 120;
        nTargetSpacingSlowLaunch = 2 * 60;  // Slow launch - Block 300)
        nTargetSpacing = 120;
        nMaturity = 59;
        ...
        nAccumulatorStartHeight = 999999999;
        nZerocoinStartTime = 1893495600;
        ...
        /** Genesis **/
        const char* pszTimestamp = "TPWR started in June 2020. Year of Corona crisis";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1590672602;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 131216;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000224b41a6f29aa84bb68928295b63b9ace770a571fd0b6be53bf7dae1013"));
        assert(genesis.hashMerkleRoot == uint256("0x48387f9b3baed115531cb6b1a19821ba2658a63b5a79a7cf8beac17cc3b22ca4"));

         vSeeds.push_back(CDNSSeedData("t-powercoin.com", "seed1.t-powercoin.com"));
         vSeeds.push_back(CDNSSeedData("t-powercoin.com", "seed2.t-powercoin.com"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x02)(0x2E)(0x24)(0x73).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x02)(0x21)(0x32)(0x2A).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x10)(0x04)(0x6D).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet tpwr addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet tpwr script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet tpwr BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet tpwr BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet tpwr BIP44 coin type is '1' (All coin's testnet default)
