...
public:
    ...
    void setZtpwrControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzTPWR_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzTPWR_clicked();
    void on_pushButtonZtpwrControl_clicked();
