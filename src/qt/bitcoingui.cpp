                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TPWR Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TPWR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tpwr: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TPWR Core"), this);
    aboutAction->setStatusTip(tr("Show information about TPWR Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TPWR"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TPWR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TPWR addresses"));
    ...
    openAction->setStatusTip(tr("Open a TPWR: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TPWR Core help message to get a list with possible TPWR command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TPWR Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TPWR network", "", count));
}
...
{
    QString strTitle = tr("TPWR Core"); // default title
...
/** Creates context menu, its actions, and tpwrs up all the relevant signals for mouse events. */
