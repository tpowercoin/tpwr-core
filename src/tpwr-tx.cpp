...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TPWR Core tpwr-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tpwr-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tpwr transaction") + "\n" +
                               "  tpwr-tx [options] -create [commands]   " + _("Create hex-encoded tpwr transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tpwr transaction
