...
Value getrawmempool(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in tpwr\n"
...
Value getblock(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zTPWRsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zTPWR denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zTPWR denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zTPWR denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zTPWR denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zTPWR denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zTPWR denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zTPWR denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zTPWR denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zTPWR denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
Value gettxout(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of tpwr addresses\n"
            "     \"tpwraddress\"   	 	(string) tpwr address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
