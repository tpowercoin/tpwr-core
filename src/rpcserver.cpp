...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TPWR features */
        {"tpwr", "masternode", &masternode, true, true, false},
        {"tpwr", "listmasternodes", &listmasternodes, true, true, false},
        {"tpwr", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tpwr", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tpwr", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tpwr", "masternodedebug", &masternodedebug, true, true, false},
        {"tpwr", "startmasternode", &startmasternode, true, true, false},
        {"tpwr", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tpwr", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tpwr", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tpwr", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tpwr", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tpwr", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tpwr", "mnbudget", &mnbudget, true, true, false},
        {"tpwr", "preparebudget", &preparebudget, true, true, false},
        {"tpwr", "submitbudget", &submitbudget, true, true, false},
        {"tpwr", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tpwr", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tpwr", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tpwr", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tpwr", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tpwr", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tpwr", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tpwr", "checkbudgets", &checkbudgets, true, true, false},
        {"tpwr", "mnsync", &mnsync, true, true, false},
        {"tpwr", "spork", &spork, true, true, false},
        {"tpwr", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"tpwr", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use tpwrd, or the -server option to tpwr-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> tpwr-cli " + methodname + " " + args + "\n";
}
